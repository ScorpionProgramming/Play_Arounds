========================================================================
    KONSOLENANWENDUNG: Verschluesselung-Projektübersicht
========================================================================

Diese Verschluesselung-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre Verschluesselung-Anwendung besteht.


Verschluesselung.vcxproj
...
Verschluesselung.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen Verschluesselung.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
